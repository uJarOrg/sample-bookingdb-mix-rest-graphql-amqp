...
helm upgrade --install --atomic --wait --timeout 2m -n $K8S_NAMESPACE prometheus prometheus-community/prometheus
...
helm upgrade --install --atomic --wait --timeout 2m -n $K8S_NAMESPACE grafana stable/grafana
